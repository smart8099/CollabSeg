...
declare -A MODEL_DIRS=(
    ...
    ["unetv2_narrow"]="${OUTDIR}/polyp_segmentation_baseline_unetv2_ep80_narrow"
...
declare -A MODEL_CFGS=(
    ...
    ["unetv2_narrow"]="configs/models/unetv2_narrow.yaml"
    ["deeplabv3plus"]="configs/models/deeplabv3plus.yaml"
)

echo "=== ep80 Test Evaluation ==="
for KEY in unet unetpp unetv2_narrow deeplabv3plus; do
    DIR="${MODEL_DIRS[$KEY]}"
    CFG="${MODEL_CFGS[$KEY]}"
